    ...
    <header>
      <div class="header">
        ...
        <div class="header__login">
          <button class="header__btn" @click="goToLogin">login</button>
        </div>
      </div>
    </header>
    <main>
      <section class="introduction">
        ...
        <button class="introduction__btn" @click="goToRegister">Get started</button>
      </section>
...
<script src="./LandingPage.vue.ts"></script>
<style src="./LandingPage.scss" scoped></style>
